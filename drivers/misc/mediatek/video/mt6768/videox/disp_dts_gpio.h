...
enum DTS_GPIO_STATE {
	...
	DTS_GPIO_STATE_TE_MODE_GPIO = 7,
	DTS_GPIO_STATE_TE_MODE_TE = 8,
	DTS_GPIO_STATE_TE1_MODE_TE = 9,
	DTS_GPIO_STATE_LCM1_RST_OUT0 = 10,
	DTS_GPIO_STATE_LCM1_RST_OUT1 = 11,
	DTS_GPIO_STATE_TP_RST_OUT0 = 12,
	DTS_GPIO_STATE_TP_RST_OUT1 = 13,
	DTS_GPIO_STATE_MAX,
};
