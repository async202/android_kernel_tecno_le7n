...
static kal_uint16
gc02m1b_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	for (gain_index = GC02M1B_SENSOR_GAIN_MAX_VALID_INDEX - 1;
...
static void sensor_init(void)
{
	...
	gc02m1b_table_write_cmos_sensor(addr_data_pair_init_gc02m1b,
...
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(addr_data_pair_preview_gc02m1b,
...
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(addr_data_pair_capture_gc02m1b,
...
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(addr_data_pair_normal_video_gc02m1b,
		   sizeof
...
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(addr_data_pair_hs_video_gc02m1b,
...
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(addr_data_pair_slim_video_gc02m1b,
...
static int get_gc02m1b_vendor_id(void)
{
	int module_id;
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xfc, 0x01);
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				vendor_id = get_gc02m1b_vendor_id();
				if (vendor_id == 0x07) {
					LOG_INF
