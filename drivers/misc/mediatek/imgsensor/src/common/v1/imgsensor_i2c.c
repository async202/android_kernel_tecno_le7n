...
{
	pr_info("imgsensor_i2c_probe_0: client=%p, adapter=%s (id=%d)\n",
		client, client ? client->adapter->name : "null",
...
{
	pr_info("imgsensor_i2c_probe_1: client=%p, adapter=%s (id=%d)\n",
		client, client ? client->adapter->name : "null",
		client ? client->adapter->nr : -1);
...
{
	pr_info("imgsensor_i2c_probe_2: client=%p, adapter=%s (id=%d)\n",
		client, client ? client->adapter->name : "null",
		client ? client->adapter->nr : -1);
...
{
	pr_info("imgsensor_i2c_probe_3: client=%p, adapter=%s (id=%d)\n",
		client, client ? client->adapter->name : "null",
		client ? client->adapter->nr : -1);
...
{
	pr_info("imgsensor_i2c_probe_4: client=%p, adapter=%s (id=%d)\n",
		client, client ? client->adapter->name : "null",
		client ? client->adapter->nr : -1);
