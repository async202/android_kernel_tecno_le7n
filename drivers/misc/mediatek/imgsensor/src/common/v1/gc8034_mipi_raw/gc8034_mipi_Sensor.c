...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr, /* Match stock boot.elf */
...
static kal_uint32 get_info(enum MSDK_SCENARIO_ID_ENUM
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	kal_uint8 *ptr = (kal_uint8 *)sensor_info;
	memset(sensor_info, 0, sizeof(MSDK_SENSOR_INFO_STRUCT));

	/* Exact Transsion stock boot.elf get_info writes */
	*(kal_uint8*)(ptr + 22) = 4;
	*(kal_uint64*)(ptr + 44) = 0x0000000200000002ULL;
	*(kal_uint64*)(ptr + 52) = 0x0000000200000002ULL;
	*(kal_uint16*)(ptr + 13) = 257;
	*(kal_uint16*)(ptr + 20) = 257;
	*(kal_uint32*)(ptr + 60) = 2;
	*(kal_uint16*)(ptr + 136) = 2;
	*(kal_uint8*)(ptr + 141) = 2;
	*(kal_uint16*)(ptr + 161) = 5;
	*(kal_uint8*)(ptr + 8) = 24;
	*(kal_uint64*)(ptr + 24) = 0x0000000500000000ULL;
	*(kal_uint64*)(ptr + 32) = 0x0000000000000001ULL;
	*(kal_uint32*)(ptr + 40) = 1;
	*(kal_uint8*)(ptr + 17) = 3;
	*(kal_uint16*)(ptr + 15) = 512;
	*(kal_uint16*)(ptr + 18) = 515;
	*(kal_uint32*)(ptr + 156) = 0;
	*(kal_uint32*)(ptr + 168) = 0;
	*(kal_uint8*)(ptr + 138) = 0;
	*(kal_uint16*)(ptr + 139) = 0;
	*(kal_uint16*)(ptr + 164) = 0;
	*(kal_uint16*)(ptr + 143) = 21760;
	*(kal_uint32*)(ptr + 150) = 16777216;
	*(kal_uint32*)(ptr + 92) = 0;
