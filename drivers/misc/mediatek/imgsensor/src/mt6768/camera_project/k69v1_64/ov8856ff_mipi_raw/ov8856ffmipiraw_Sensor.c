...
#include "ov8856ffmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV8856FF_SENSOR_ID,		/*record sensor id defined in Kd_imgsensor.h*/
...
static kal_uint16 ov8856ff_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
kal_uint16 addr_data_pair_init_ov8856ff[] = {
	0x0103, 0x01,
	0x0302, 0x3c,
	0x0303, 0x01,
	0x031e, 0x0c,
...
static void sensor_init(void)
{
	LOG_INF("v3 E\n");
#if 1	/* MULTI_WRITE */
	ov8856ff_table_write_cmos_sensor(addr_data_pair_init_ov8856ff,
			   sizeof(addr_data_pair_init_ov8856ff) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_ov8856ff[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366e, 0x08,
	0x3714, 0x27,
...
#endif
	ov8856ff_table_write_cmos_sensor(addr_data_pair_preview_ov8856ff,
				   sizeof(addr_data_pair_preview_ov8856ff) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_ov8856ff[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
kal_uint16 addr_data_pair_capture_15fps_ov8856ff[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
#endif
	if (currefps == 150) {
		ov8856ff_table_write_cmos_sensor(addr_data_pair_capture_15fps_ov8856ff,
					       sizeof(addr_data_pair_capture_15fps_ov8856ff) /
					       sizeof(kal_uint16));
	} else {
		ov8856ff_table_write_cmos_sensor(addr_data_pair_capture_30fps_ov8856ff,
					       sizeof(addr_data_pair_capture_30fps_ov8856ff) /
					       sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_vga_setting_120fps_ov8856ff[] = {
	0x3501, 0x25,
	0x3502, 0xc0,
	0x366e, 0x08,
	0x3714, 0x29,
...
static void vga_setting_120fps(void)
{
	...
	ov8856ff_table_write_cmos_sensor(addr_data_pair_vga_setting_120fps_ov8856ff,
				   sizeof(addr_data_pair_vga_setting_120fps_ov8856ff) /
				   sizeof(kal_uint16));
...
UINT32 OV8856FF_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV8856FF_MIPI_RAW_SensorInit	*/
